...
<body>
    ...
    <nav class="w3-sidebar w3-bar-block w3-card w3-animate-left w3-center" style="display:none" id="mySidebar">
        ...
        <a href="#" class="w3-bar-item w3-button">Masukan Data</a>
        <a href="#" class="w3-bar-item w3-button">Tampilkan Data</a>
        <a href="#" class="w3-bar-item w3-button">Lain - lain</a>
        <a href="#" class="w3-bar-item w3-button">Lain - lain</a>
    </nav>
    ...
    <header class="w3-container w3-theme w3-padding" id="myHeader">
        ...
        <div class="w3-center">
            ...
            <h1 class="w3-xxxlarge w3-animate-bottom">MENU MAHASISWA</h1>
            <!--
    ...
    <div class="w3-row-padding w3-center w3-margin-top center">
        <div class="w3-third">
            <div class="w3-card w3-container center1" style="min-height:460px">
                <h3>Masukan Mahasiswa</h3><br>
                <i class="fa fa-desktop w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
                <p>Menu untuk melakukan masukan terhadap data Mahasiswa</p></br>

                <a class="w3-button w3-theme" href="#input">Masukan Data</a>
            </div>
        </div>
        ...
        <div class="w3-third">
            <div class="w3-card w3-container center1" style="min-height:460px">
                ...
                <i class="fa fa-desktop w3-margin-bottom w3-text-theme" style="font-size:120px"></i>
                <p>Menu untuk menampilkan data Mahasiswa, melakukan edit, delete pada data mahasiswa</p>

                <a class="w3-button w3-theme" href="#show">Tampil Data</a>
            </div>
        </div>
    </div>
    <!--
    ...
    <div class="w3-row-padding" id="input">
        <div>
            <form class="w3-container w3-card-4" action="addData.php" method="post" name="add" enctype="multipart/form-data">
                <h2 class="center2">Masukan Data Mahasiswa</h2>
                <div class="w3-section">
                    <label>NIM</label>
                    <input class="w3-input" type="text" name="nim" required>
                </div>
                <div class="w3-section">
                    <label>Nama Lengkap</label>
                    <input class="w3-input" type="text" name="nama" required>
                </div>
                <div class="w3-section">
                    <label>Alamat</label>
                    <input class="w3-input" type="text" name="alamat" required>
                </div>
                <div class="w3-section">
                    <label>No. HP</label>
                    <input class="w3-input" type="text" name="nohp" required>
                </div>
                <div class="w3-section">
        ...
        <div>
            <form action="index.php#show" method="get">
                <div class="w3-section">
                    ...
                    <input class="w3-input" type="text" name="cari" required></br>
                    <input type="submit" value="Cari" href="#show">
                </div>
            </form>

            <form action="index.php#show" method="get">
                <div class="w3-section">
                    <input type="submit" value="Tampilkan Semua Data" href="#show">
                </div>
            </form>
            <?php
            if (isset($_GET['cari']) ) {
            ...
            <table class="w3-table w3-striped w3-bordered">
                ...
                <tbody>
                    ...
                    if (isset($_GET['cari'])) {
                        $cari = $_GET['cari'];
                        $query = "SELECT * FROM tbl_mahasiswa where nama like '%" . $cari . "%'";
                    ...
                    ?>
                        <tr>
                            ...
                            <a href=\"delete.php?nim=$row[nim]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a> | <a href=\"editPhoto.php?nim=$row[nim]\">Edit Photo</a> </td>";
                            echo "</td>";
                            ?>
                        </tr>
