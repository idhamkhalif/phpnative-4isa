...
<body>
    ...
    <div class="w3-row-padding" id="input">
        <div>
            <form class="w3-container w3-card-4" action="editAction.php" method="post" name="edit" enctype="multipart/form-data">
                ...
                <div class="w3-section">
                    <label>Alamat</label>
                    <input class="w3-input" type="text" name="alamat" value="<?php echo $alamat; ?>" required>
                </div>
                <div class="w3-section">
                    <label>No. HP</label>
                    <input class="w3-input" type="text" name="nohp" value="<?php echo $nohp; ?>" required>
                </div>
                <div class="w3-section">
                    <label>Password</label>
                    <input class="w3-input" type="password" name="password" value="<?php echo $password; ?>" required>
                </div>

                <div class="w3-section center2">
                <td><input type="hidden" name="id" value=<?php echo $nim; ?>></td>
